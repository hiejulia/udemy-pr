...
<section class="container">
	<form:form method="POST" modelAttribute="newProduct"
		...
		<fieldset>
			...
			<div class="form-group">
				<label class="control-label col-lg-2 col-lg-2" for="teacher"><spring:message
						code="addProduct.form.manufacturer.label" /></label>
				<div class="col-lg-10">
					<form:input id="teacher" path="teacher" type="text"
						class="form:input-large" />
				</div>
			</div>
			...
			<div class="form-group">
				<label class="control-label col-lg-2 col-lg-2" for="seatAvailable"><spring:message
						code="addProduct.form.unitsInStock.label" /></label>
				<div class="col-lg-10">
					<form:input id="seatAvailable" path="seatAvailable" type="text"
						class="form:input-large" />
				</div>
			</div>
